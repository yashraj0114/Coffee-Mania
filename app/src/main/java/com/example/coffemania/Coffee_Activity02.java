...
public class Coffee_Activity02 extends AppCompatActivity {
...
//    int c1 = 0;   used before
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        increment_quantity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(Coffee_Activity02.this, "Increase", Toast.LENGTH_SHORT).show();

                quantity = quantity + 1;
                final_quantity = String.valueOf(quantity);
                quantity_tv.setText(final_quantity);


//                price = price + 249;
                final_summary = confirm_total + confirm_total + confirm_total;
        ...
        decrement_quantity.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(Coffee_Activity02.this, "Decrease", Toast.LENGTH_SHORT).show();
        ...
        Intent intent = new Intent(Coffee_Activity02.this, MainActivity2.class);
...
//        final_price_tv6.setText(mcoffee_price6);
        ...
        String mcoffee_price2 = getIntent().getStringExtra("mcoffee2");
        final_price_tv.setText(mcoffee_price2);
        ...
        update_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (typeofuser.equals("0")) {
                    Toast.makeText(Coffee_Activity02.this, "Select Glass Size", Toast.LENGTH_SHORT).show();
                } else if (typeofpass.equals("0")) {
                    Toast.makeText(Coffee_Activity02.this, "Select Coffee Type", Toast.LENGTH_SHORT).show();
                } else {
...
//                    String mcoffee_price1 =getIntent().getStringExtra("mcoffee1");
//                    c1 = Integer.parseInt(mcoffee_price1);




                    confirm_total = c2 + add;
        ...
        buy_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                sheetDialog = new BottomSheetDialog(Coffee_Activity02.this, R.style.BottomSheetStyle);
                ...
                sheetview.findViewById(R.id.place_order).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (u_n.equals("abc") && p_tv.equals("1234")) {
                            ...
                            Toast.makeText(Coffee_Activity02.this, "Worked Login succcele", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(Coffee_Activity02.this, "Fail", Toast.LENGTH_SHORT).show();
